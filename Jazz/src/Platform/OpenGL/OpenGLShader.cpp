...
namespace Jazz {
    ...
    static GLenum ShaderTypeFromString(const std::string &type) {
        ...
        JZ_CORE_ASSERT(false, "Unknown shader type!");
        return 0;
    }
    ...
    void OpenGLShader::Compile(const std::unordered_map<GLenum, std::string> &shaderSources) {
        ...
        JZ_CORE_ASSERT(shaderSources.size() <= 2, "We only support 2 shaders for now");
        ...
        for (auto &kv: shaderSources) {
            ...
            if (isCompiled == GL_FALSE) {
                ...
                JZ_CORE_ERROR("{0}", infoLog.data());
                JZ_CORE_ASSERT(false, "Shader compilation failure!");
                break;
            }
        ...
        if (isLinked == GL_FALSE) {
            ...
            JZ_CORE_ERROR("{0}", infoLog.data());
            JZ_CORE_ASSERT(false, "Shader link failure!");
            return;
        }
